...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.container_classes = "chzn-container";
      if (this.is_rtl) {
        this.container_classes += " chzn-rtl";
      }
      if (this.form_field.readAttribute('class')) {
        this.container_classes += " " + this.form_field.readAttribute('class');
      }
      this.f_width = this.form_field.getStyle("width") ? parseInt(this.form_field.getStyle("width"), 10) : this.form_field.getWidth();
      container_props = {
        'id': this.container_id,
        'class': this.container_classes,
